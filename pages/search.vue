      ...
      <b-container>
        <b-row>
          <b-col md="8" offset-md="2">
            ...
            <p v-if="dataSearch" class="search-p">Pencarian "{{ this.search }}" ditemukan sebagai berikut :</p>
            <p v-else class="search-p">Pencarian "{{ this.search }}" tidak ditemukan</p>
...
export default {
  head() {
    return {
      ...
      meta: [
        { hid: 'title', name: 'title', content: 'Search | Departemen Kardiologi dan Kedokteran Vaskular FK UI' },
        { hid: 'og:title', name: 'og:title', content: 'Search | Departemen Kardiologi dan Kedokteran Vaskular FK UI' },
