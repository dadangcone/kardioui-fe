...
export default {
  head() {
    return {
      title:
        "Kerjasama Penelitian | Departemen Kardiologi dan Kedokteran Vaskular FK UI",
      meta: [
        {
          hid: "title",
          name: "title",
  ...
  methods: {
    async getKP() {
      let tempKP = await this.$axios.$get(
        `/kerjasama-penelitian?search=` +
