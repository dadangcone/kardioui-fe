                ...
                <b-col md="8">
                  ...
                  <div class="content-inner">
                    ...
                    <b-row>
                      <b-col
                        md="6"
                        v-for="fasil in dataPenelitian.fasilitas_penelitian_image"
                        :key="fasil.id"
                      >
                        <div
                          class="image-grid"
                          :style="{
                            backgroundImage: 'url(' + fasil.url_image + ')'
                          }"
                        ></div>
                      </b-col>
                    </b-row>
...
export default {
  head() {
    return {
      title:
        "Fasilitas Penelitian | Departemen Kardiologi dan Kedokteran Vaskular FK UI",
      meta: [
        {
          hid: "title",
          name: "title",
