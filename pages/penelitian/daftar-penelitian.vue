...
export default {
  head() {
    return {
      title:
        "Daftar Penelitian | Departemen Kardiologi dan Kedokteran Vaskular FK UI",
      meta: [
        {
          hid: "title",
          name: "title",
  ...
  methods: {
    async getDP() {
      let tempDP = await this.$axios.$get(
        `/daftar-penelitian?search=` +
